    ...
    <div class="container" style="width:600px;">
        ...
        <form method="post" id="update_products" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="productImage" id="UproductImage" class="form-control" required />
            </div>
            <div class="form-group">
            ...
            <br />
            <div align='center'>
                <input type="submit" name="insert" id="action" class="btn btn-info" value="UPDATE" />
